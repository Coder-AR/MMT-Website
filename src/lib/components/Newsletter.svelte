...
<!-- Begin Mailchimp Signup Form -->
    ...
    <div class="mc-field-group">
        <label for="mce-undefined">Student Grade (2025-26) <span class="asterisk">*</span></label>
    ...
    <div class="mc-field-group">
        ...
        <select name="STATE" class="" bind:value={state} id="mce-STATE">
            ...
            <option value="Other U.S. Territory">Other U.S. Territory</option>
            <option value="Not in the U.S.">Not in the U.S.</option>
    
        </select>
        <span id="mce-STATE-HELPERTEXT" class="helper_text"></span>
    </div>
    <div class="mc-field-group">
    ...
    <div>
    <div id="mce-responses" class="clear foot" style="width: 0%;">
